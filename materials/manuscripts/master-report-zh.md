# A Study on Co-creation Tools for Designing Interpretive Signage Research on Design Strategy ———— Case Study of Fukuoka City Botanical Garden Greenhouse

**2DS25010K PINGCHENG WANG**

![image001.png](修士报告.fld/image001.png)
...
![image002.png](修士报告.fld/image002.png)

![image003.png](修士报告.fld/image003.png)
...
![image004.png](修士报告.fld/image004.png)

![image005.png](修士报告.fld/image005.png)
...
[1] Bitgood, S. (2013). Attention and value: Keys to understanding museum visitors. Left Coast Press.

[2] Ham, S. (2016). Interpretation: Making a difference on purpose. Fulcrum Publishing.

[3] Paivio, A. (1971). Imagery and verbal processes. Holt, Rinehart, and Winston.

[4] Serrell, B. (2015). Exhibit labels: An interpretive approach. Bloomsbury Publishing.

[5] Spooner, S. L., et al. (2024). Using eye-tracking to create impactful interpretation signage for botanic gardens. Journal of Zoological and Botanical Gardens, 5(3), 434-454.

[6] Sweller, J. (1988). Cognitive load during problem solving: Effects on learning. Cognitive Science, 12(2), 257-285.

[7] Tilden, F. (1957). Interpreting our heritage. University of North Carolina Press.

[8] Wang, P., & Zhang, Y. (2025a). 共創による植物園解説サインに関する研究Ⅰ. 日本デザイン学会研究発表大会概要集, 91.ll