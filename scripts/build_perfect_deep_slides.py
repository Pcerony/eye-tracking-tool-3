...
deep_slides = [
    # 0. Section Cover Slide
    {
        ...
        "chapter": "5",
        "chapterTitle": "深度分析",
        "shortTitle": "阶段五：深度分析封面",
        "animation": "hero",
        "legacyLayout": "SWISS-CLOSING-ASCII",
        "legacyClass": "slide split",
        "assets": [],
        "claims": [],
        "markup": '<div class="canvas-card"><div class="split-half"><div class="half b-accent" style="padding:54px 48px;justify-content:space-between;position:relative;overflow:hidden"><canvas class="ascii-bg" aria-hidden="true"></canvas><div class="chrome-min" style="position:relative;z-index:1"><div class="l">PHASE 05 · DEEP COGNITIVE ANALYSIS</div><div class="r">STAGE COVER</div></div><div style="display:flex;flex-direction:column;gap:18px;position:relative;z-index:1"><span style="font-family:var(--mono);font-size:14px;letter-spacing:0.12em;color:rgba(255,255,255,0.7);font-weight:700">SHANNON INFORMATION THEORY</span><h2 style="font-family:var(--sans),var(--sans-zh);font-size:46px;line-height:1.08;font-weight:200;color:#fff;letter-spacing:-0.02em" data-i18n="slides.s18cover.title">基于信息熵与惊讶度的深度认知分析</h2><p style="font-size:18px;color:rgba(255,255,255,0.85);line-height:1.55;font-weight:400;margin:0" data-i18n="slides.s18cover.desc">超越表面注视时长假象 · 构建计算认知科学量化模型与全量实证检验</p></div><div style="border-top:1px solid rgba(255,255,255,0.22);padding-top:16px;position:relative;z-index:1;display:flex;justify-content:space-between"><span class="t-meta" style="color:rgba(255,255,255,0.65)">COMPUTATIONAL COGNITION</span><span class="t-meta" style="color:rgba(255,255,255,0.65)">N = 13 (27 TRIALS)</span></div></div><div class="half" style="padding:54px 44px;justify-content:space-between;background:#fff"><div class="chrome-min"><div class="l">RESEARCH ROADMAP</div><div class="r">3 CORE PILLARS</div></div><div style="display:flex;flex-direction:column;gap:24px"><div style="display:grid;grid-template-columns:40px 1fr;gap:16px;border-top:1px solid var(--border-subtle);padding-top:16px"><div style="font-family:var(--mono);font-size:16px;font-weight:700;color:var(--accent)">01</div><div><h3 style="font-size:20px;font-weight:600;color:var(--ink);margin:0 0 6px" data-i18n="slides.s18cover.p1.title">理论重构：香农惊讶度建模</h3><p style="font-size:15px;color:var(--text-primary);line-height:1.5;margin:0" data-i18n="slides.s18cover.p1.body">指出传统时长指标将“阅读摩擦”误判为沉浸的缺陷，引入自信息量 I = -log₂(P) 量化反常识感官互动的高知识价值。</p></div></div><div style="display:grid;grid-template-columns:40px 1fr;gap:16px;border-top:1px solid var(--border-subtle);padding-top:16px"><div style="font-family:var(--mono);font-size:16px;font-weight:700;color:var(--accent)">02</div><div><h3 style="font-size:20px;font-weight:600;color:var(--ink);margin:0 0 6px" data-i18n="slides.s18cover.p2.title">动力学解构：马尔可夫转移矩阵</h3><p style="font-size:15px;color:var(--text-primary);line-height:1.5;margin:0" data-i18n="slides.s18cover.p2.body">运用一阶马尔可夫链证实长文本区 93% 自循环停滞陷阱，证明共创标牌成功实现向多模态区域的顺畅导流。</p></div></div><div style="display:grid;grid-template-columns:40px 1fr;gap:16px;border-top:1px solid var(--border-subtle);padding-top:16px"><div style="font-family:var(--mono);font-size:16px;font-weight:700;color:var(--accent)">03</div><div><h3 style="font-size:20px;font-weight:600;color:var(--ink);margin:0 0 6px" data-i18n="slides.s18cover.p3.title">全量实证：13人有效吸收量翻倍</h3><p style="font-size:15px;color:var(--text-primary);line-height:1.5;margin:0" data-i18n="slides.s18cover.p3.body">配对检验证实 E_gain 跃升 +127.7%（p&lt;0.000001, d=3.46），13 位被试全部单调上升，能效比提升 29.9%。</p></div></div></div><div class="t-meta" style="color:var(--text-helper);text-align:right">ENTER PHASE 05</div></div></div></div>'
    },
    ...
    # 12. s18i4: Chart D (SGE & KL)
    {
        ...
        "claims": [],
        "markup": '<div class="canvas-card analysis-data-slide"><div class="chrome-min"><div class="l">PHASE 5 · EMPIRICAL CHARTS · SPATIAL GAZE STRUCTURE</div><div class="r">31 / 37</div></div><div class="analysis-header-row"><div class="analysis-header-left"><h2 class="analysis-kicker" data-i18n="slides.s18i4.title">空间注视均衡度 (SGE) 与设计对齐 (KL 散度)</h2><div class="analysis-kicker-desc" data-i18n="slides.s18i4.guide">【图表D】量化视线空间离散度与共创设计预期的拟合收敛程度</div></div><div class="analysis-anim-badge" aria-label="SGE Animation"><span class="analysis-anim-label">CHART D</span><svg width="116" height="30" viewBox="0 0 116 30" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="10" width="20" height="15" fill="#64748b"/><rect x="40" y="6" width="20" height="19" fill="#059669"/></svg></div></div><div class="analysis-body-group" style="flex:1;display:grid;grid-template-columns:1.3fr 1fr;gap:28px;align-items:center"><div style="background:#fff;border:1px solid var(--border-subtle);border-radius:4px;padding:12px;display:flex;justify-content:center;align-items:center;height:500px"><img src="asset:entropy-chart-sge" alt="SGE Chart" style="max-width:100%;max-height:100%;object-fit:contain"></div><div style="display:flex;flex-direction:column;gap:20px"><div style="background:#fff;border:1px solid var(--border-subtle);padding:26px 26px;border-radius:4px"><span style="font-family:var(--mono);font-size:12px;color:var(--accent);font-weight:700">SPATIAL GAZE ENTROPY</span><h4 style="font-size:22px;color:var(--ink);font-weight:600;margin:6px 0 10px">空间注视均衡度 SGE: +66.9%</h4><p style="font-size:16.5px;color:var(--text-primary);line-height:1.65;margin:0">1.203 &rarr; 2.008 bits (t=7.636, p&lt;0.0001)。证明视线不再单极化聚集在文本区，而是均匀覆盖了插图、花语和互动气泡。</p></div><div style="background:#fff;border:1px solid var(--border-subtle);border-left:4px solid var(--accent);padding:26px 26px;border-radius:4px"><span style="font-family:var(--mono);font-size:12px;color:var(--accent);font-weight:700">DESIGN CONVERGENCE</span><h4 style="font-size:22px;color:var(--ink);font-weight:600;margin:6px 0 10px">KL 散度与设计预期对齐</h4><p style="font-size:16.5px;color:var(--text-primary);line-height:1.65;margin:0">D_KL 量化了实际视线分布与工坊设计意图的匹配度，证实共创原则成功达成了预期的人机交互导流目标。</p></div></div></div></div>'
    },
    # 13. s18j: Empirical Summary
    {
        ...
        "assets": [],
        "claims": [],
        "markup": '<div class="canvas-card analysis-data-slide"><div class="chrome-min"><div class="l">PHASE 5 · DEEP COGNITIVE ANALYSIS · EMPIRICAL SUMMARY</div><div class="r">32 / 37</div></div><div class="analysis-header-row"><div class="analysis-header-left"><h2 class="analysis-kicker" data-i18n="slides.s18j.title">全量实证结果：有效认知信息吸收量翻倍暴增</h2><div class="analysis-kicker-desc" data-i18n="slides.s18j.guide">【全量验证】13 位被试配对检验证实有效认知吸收量与能效比实现全面跃升</div></div><div class="analysis-anim-badge" aria-label="Evidence Animation"><span class="analysis-anim-label">EVIDENCE</span><svg width="116" height="30" viewBox="0 0 116 30" fill="none" xmlns="http://www.w3.org/2000/svg"><line x1="6" y1="25" x2="110" y2="25" stroke="var(--border-subtle)" stroke-width="1.5" /><path d="M 10 25 C 28 25, 42 6, 58 6 C 74 6, 88 25, 106 25" stroke="var(--ink)" stroke-width="1.5" fill="none" /><line x1="84" y1="11" x2="84" y2="25" stroke="var(--accent)" stroke-width="1.5" stroke-dasharray="2 2" /><g class="anim-stat-star"><circle cx="94" cy="17" r="3.5" fill="var(--accent)" /><circle cx="94" cy="17" r="7" stroke="var(--accent)" stroke-width="1" opacity="0.4" /></g></svg></div></div><div class="analysis-body-group" style="flex:1;display:flex;flex-direction:column;justify-content:center;gap:24px"><div class="analysis-hero-grid"><div class="analysis-sub-stack"><div class="analysis-sub-card"><span class="lbl">PAIRED T-TEST</span><span class="nb">t(12) = 12.48<span class="unit">***</span></span></div><div class="analysis-sub-card"><span class="lbl">EFFECT SIZE</span><span class="nb">d = 3.46<span class="unit">Huge</span></span></div><div class="analysis-sub-card"><span class="lbl">EFFICIENCY (η)</span><span class="nb">+29.9<span class="unit">% (p=0.004)</span></span></div></div><div class="analysis-hero-card"><h3 class="analysis-hero-title" data-i18n="slides.s18j.kpi.title">有效认知信息吸收总量 (E_gain)</h3><div class="analysis-hero-num">+127.7<span class="unit">%</span></div><div class="analysis-hero-sub" data-i18n="slides.s18j.kpi.sub">0.585 bits → 1.332 bits (p &lt; 0.000001 ***) | 全量 13 位被试全部单调显著上升</div></div></div><div class="analysis-visual-row" style="grid-template-columns:1fr 1fr;gap:24px"><div style="background:#fff;border:1px solid var(--border-subtle);padding:24px 28px;border-radius:4px;display:flex;flex-direction:column;gap:8px"><div style="display:flex;justify-content:space-between;align-items:center"><span style="font-family:var(--mono);font-size:12px;color:var(--accent);font-weight:700">KNOWLEDGE ABSORPTION GAIN</span><span style="font-size:20px;font-weight:700;color:var(--accent)">+127.7%</span></div><h4 style="font-size:22px;color:var(--ink);font-weight:600;margin:0" data-i18n="slides.s18j.box1.title">真实认知获取成倍跃升</h4><p style="font-size:16.5px;color:var(--text-primary);line-height:1.55;margin:0" data-i18n="slides.s18j.box1.body">将注视时间与信息惊讶度结合后，实验组有效知识获得量翻倍，13 位被试无一下降（+86.8% ~ +243.1%）。</p></div><div style="background:#fff;border:1px solid var(--border-subtle);padding:24px 28px;border-radius:4px;display:flex;flex-direction:column;gap:8px"><div style="display:flex;justify-content:space-between;align-items:center"><span style="font-family:var(--mono);font-size:12px;color:var(--accent);font-weight:700">PROCESSING EFFICIENCY (η)</span><span style="font-size:20px;font-weight:700;color:var(--accent)">+29.9%</span></div><h4 style="font-size:22px;color:var(--ink);font-weight:600;margin:0" data-i18n="slides.s18j.box2.title">认知信息传递能效比显著提升</h4><p style="font-size:16.5px;color:var(--text-primary);line-height:1.55;margin:0" data-i18n="slides.s18j.box2.body">能效比从 1.083 提升至 1.407（p = 0.004, d = 0.982），证明观众以更少、更舒适的视觉搜索换取了更高价值的信息。</p></div></div></div></div>'
    },
    # 14. s18k: 13-Participant Table
    {
        ...
        "assets": [],
        "claims": [],
        "markup": '<div class="canvas-card analysis-data-slide"><div class="chrome-min"><div class="l">PHASE 5 · DEEP COGNITIVE ANALYSIS · PARTICIPANTS DATA LEDGER</div><div class="r">33 / 37</div></div><div class="analysis-header-row"><div class="analysis-header-left"><h2 class="analysis-kicker" data-i18n="slides.s18k.title">全量 13 位被试逐人明细数据表 (Group A &amp; B)</h2><div class="analysis-kicker-desc" data-i18n="slides.s18k.guide">【逐人明细】记录 Group A (7人) 与 Group B (6人) 每位被试的对照与改良数据及增益率</div></div><div class="analysis-anim-badge" aria-label="Ledger Animation"><span class="analysis-anim-label">LEDGER</span><svg width="116" height="30" viewBox="0 0 116 30" fill="none" xmlns="http://www.w3.org/2000/svg"><line x1="10" y1="8" x2="106" y2="8" stroke="var(--border-subtle)" stroke-width="1.5" /><line x1="10" y1="15" x2="106" y2="15" stroke="var(--border-subtle)" stroke-width="1.5" /><line x1="10" y1="22" x2="106" y2="22" stroke="var(--border-subtle)" stroke-width="1.5" /></svg></div></div><div class="analysis-body-group" style="flex:1;display:flex;flex-direction:column;justify-content:center"><div style="background:#fff;border:1px solid var(--border-subtle);border-radius:4px;padding:32px 40px;display:grid;grid-template-columns:1fr 1fr;gap:48px;font-size:16px"><div style="display:flex;flex-direction:column;gap:12px"><div style="font-weight:700;color:var(--accent);border-bottom:2px solid var(--border-subtle);padding-bottom:10px;margin-bottom:6px;display:flex;justify-content:space-between"><span style="font-size:17px">GROUP A · 九重葛 (N=7)</span><span style="font-size:14px;color:var(--text-secondary);font-weight:400">Ctrl → Exp (ΔE_gain)</span></div><div style="display:flex;justify-content:space-between"><span>akama_kumiko:</span><span>0.403 &rarr; 1.246 <strong style="color:var(--accent);margin-left:8px">+208.9%</strong></span></div><div style="display:flex;justify-content:space-between"><span>ataqi:</span><span>0.487 &rarr; 1.326 <strong style="color:var(--accent);margin-left:8px">+172.4%</strong></span></div><div style="display:flex;justify-content:space-between"><span>harada_keiko:</span><span>0.589 &rarr; 1.385 <strong style="color:var(--accent);margin-left:8px">+135.2%</strong></span></div><div style="display:flex;justify-content:space-between"><span>koga_eiichi:</span><span>0.366 &rarr; 0.974 <strong style="color:var(--accent);margin-left:8px">+166.0%</strong></span></div><div style="display:flex;justify-content:space-between"><span>moro_izumi:</span><span>0.699 &rarr; 1.429 <strong style="color:var(--accent);margin-left:8px">+104.4%</strong></span></div><div style="display:flex;justify-content:space-between"><span>saku_yoshisuke:</span><span>0.702 &rarr; 1.408 <strong style="color:var(--accent);margin-left:8px">+100.6%</strong></span></div><div style="display:flex;justify-content:space-between"><span>yamada_rena:</span><span>0.828 &rarr; 1.547 <strong style="color:var(--accent);margin-left:8px">+86.8%</strong></span></div></div><div style="display:flex;flex-direction:column;gap:12px"><div style="font-weight:700;color:var(--accent);border-bottom:2px solid var(--border-subtle);padding-bottom:10px;margin-bottom:6px;display:flex;justify-content:space-between"><span style="font-size:17px">GROUP B · 千日小坊 (N=6)</span><span style="font-size:14px;color:var(--text-secondary);font-weight:400">Ctrl → Exp (ΔE_gain)</span></div><div style="display:flex;justify-content:space-between"><span>abcde:</span><span>0.603 &rarr; 1.295 <strong style="color:var(--accent);margin-left:8px">+114.7%</strong></span></div><div style="display:flex;justify-content:space-between"><span>kimura:</span><span>0.562 &rarr; 1.300 <strong style="color:var(--accent);margin-left:8px">+131.3%</strong></span></div><div style="display:flex;justify-content:space-between"><span>nonntixyan:</span><span>0.607 &rarr; 1.411 <strong style="color:var(--accent);margin-left:8px">+132.5%</strong></span></div><div style="display:flex;justify-content:space-between"><span>p186:</span><span>0.567 &rarr; 1.111 <strong style="color:var(--accent);margin-left:8px">+95.9%</strong></span></div><div style="display:flex;justify-content:space-between"><span>rep_chen:</span><span>0.793 &rarr; 1.513 <strong style="color:var(--accent);margin-left:8px">+90.7%</strong></span></div><div style="display:flex;justify-content:space-between"><span>umetu_ayane:</span><span>0.399 &rarr; 1.370 <strong style="color:var(--accent);margin-left:8px">+243.1%</strong></span></div></div></div></div></div>'
    },
...
print(f"[*] 成功输出 {len(deep_slides)} 张深度分析幻灯片（含帅气封面页）！")

# Update deck-manifest.json
